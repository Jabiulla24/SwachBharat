...
<body>
<p><a href="complaints.php">REFRESH RECORDS</a> </p>
...
<thead>
   ...
   <tr><td scope="row"><?php echo $row["pid"];?>&nbsp;</td>
     ...
     <td align="center">
	<a align="center"  href="del_photogallery.php?pid=<?php echo $row["pid"];?>" >
<IMG src="up.png" width="100" height="50"></a></td>
   </tr>
   </tr>
   <?php
